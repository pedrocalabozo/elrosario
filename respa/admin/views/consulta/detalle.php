...
<BR>
            ...
            <label for="">codigo de credito</label><br>
           
 <select  class="form-control form-control-sm rounded-0" name="telefono1" id="">
             
           <option value="<?php echo $this->alumno->telefono1; ?>"><?php echo $this->alumno->telefono1; ?></option>
