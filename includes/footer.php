<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 Descarga aquí tus constancias estudiantiles en línea, solo tienes que introducir la cédula y seleccionar el tipo de constancia que necesitas
  </p></strong>
...
<div class="form-group">
          <h4>Costo 10Bs</h4>
          <div><h4>Pago Movil</h4>
            <p>0102 042400000000 25000000</p></div>
         <label for="email">#Referencia de Pago</label>
         <input type="number" name="pagomovil"   id="pagomovil" class="form-control">
       </div>


   
       <button onclick="enviosolicitud()" class="btn btn-primary">Generar Constancia</button>
...
<a href="#" style="z-index: 2;" class="scroll-to-top"><i class="fa fa-arrow-up" aria-hidden="true"></i><span class="sr-only">Ir arriba</span></a>
...
<p>Este sitio web fue desarrollado por Luis Buroz y Aarón Peralta, Estudiantes de la UPTLL Juana Ramirez, en Calabozo - Estado Guárico</p>
</div>
    </div></div>
